				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-9 order-1 order-lg-2">
						...
						<form role="form" class="needs-validation" novalidate="novalidate">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2">Date</label>
								<div class="col-lg-9">
									<input class="form-control text-3 h-auto py-2" type="date" name="date" value="">
								</div>
							</div>
							<div class="form-group row">
			...
			<div class="container py-5 mt-5">
				<div class="row">
					<div class="col-lg-3 mb-4 mb-lg-0">
						<a href="demo-finance.html" title="Porto Finance">
					...
					<div class="col-lg-3 mb-4 mb-lg-0">
						...
						<ul class="list list-unstyled columns-lg-2 text-3-5">
							<li><a href="demo-finance.html">Home</a></li>
