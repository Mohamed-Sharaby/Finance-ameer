...
<head>
	...
	<title>Demo Finance | Porto - Responsive HTML5 Template</title>
							...
							<div class="col-auto d-flex align-items-center">
								<div class="header-nav-top">
									...
									<div class="dropdown-menu dropdown-menu-arrow-centered min-width-0" aria-labelledby="dropdownLanguage">
										...
										</a>lass="header-social-icons social-icons social-icons-clean social-icons-icon-dark border border-top-0 border-end-0 border-bottom-0 ps-3 ms-2 mb-0 d-none d-sm-block">
											...
											<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
												<nav class="collapse">
													<ul class="nav nav-pills" id="mainNav">
														...
														<li>
															<a class="nav-link" href="demo-finance-company.html">
																Company
															</a>
														</li>
														<li>
															<a class="nav-link" href="demo-finance-strategies.html">
																Strategies
															</a>
														</li>
														<li>
															<a class="nav-link" href="demo-finance-team.html">
																Team
															</a>
														</li>
														<li>
															<a class="nav-link active" href="demo-finance-blog.html">
																News
															</a>
														</li>
														<li>
															<a class="nav-link" href="demo-finance-contact-us.html">
																Contact
															</a>
														</li>
													</ul>
				...
				<div class="container position-relative z-index-2">
					<div class="row text-center text-md-start">
						<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
							<h1 class="font-weight-bold text-color-light text-10 mb-0">How to Grow your Business</h1>
						</div>
						<div class="col-md-4 order-1 order-md-2 align-self-center">
							<ul class="breadcrumb breadcrumb-light d-block text-md-end text-4 mb-0">
								<li><a href="index.html" class="text-decoration-none">Home</a></li>
								<li class="text-upeercase active">How to Grow your Business</li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="card border-0">
								<div class="card-body z-index-1 p-0">
									...
									<div class="card-body p-0">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur lectus lacus, rutrum sit amet placerat et, bibendum nec mauris. Duis molestie, purus eget placerat viverra, nisi odio gravida sapien, congue tincidunt nisl ante nec tellus. Vestibulum ante
											ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sagittis, massa fringilla consequat blandit, mauris ligula porta nisi, non tristique enim sapien vel nisl. Suspendisse
											vestibulum lobortis dapibus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Praesent nec tempus nibh. Donec mollis commodo metus et fringilla. Etiam venenatis, diam id adipiscing convallis, nisi eros lobortis
											tellus, feugiat adipiscing ante ante sit amet dolor. Vestibulum vehicula scelerisque facilisis. Sed faucibus placerat bibendum. Maecenas sollicitudin commodo justo, quis hendrerit leo consequat ac. Proin sit amet risus sapien, eget interdum dui. Proin
											justo sapien, varius sit amet hendrerit id, egestas quis mauris.</p>
										<p>Ut ac elit non mi pharetra dictum nec quis nibh. Pellentesque ut fringilla elit. Aliquam non ipsum id leo eleifend sagittis id a lorem. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam massa mauris, viverra et
											rhoncus a, feugiat ut sem. Quisque ultricies diam tempus quam molestie vitae sodales dolor sagittis. Praesent commodo sodales purus. Maecenas scelerisque ligula vitae leo adipiscing a facilisis nisl ullamcorper. Vestibulum ante ipsum primis in faucibus
											orci luctus et ultrices posuere cubilia Curae;</p>
										<p>Curabitur non erat quam, id volutpat leo. Nullam pretium gravida urna et interdum. Suspendisse in dui tellus. Cras luctus nisl vel risus adipiscing aliquet. Phasellus convallis lorem dui. Quisque hendrerit, lectus ut accumsan gravida, leo tellus porttitor
												...
												<li>
													<div class="comment">
														...
														<div class="comment-block">
															...
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae, gravida pellentesque urna varius vitae. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra
																euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum nec metus. Mauris ultricies, justo eu convallis placerat, felis enim ornare nisi, vitae mattis nulla ante id dui.</p>
												...
												<div class="p-2">
													...
													<div class="row">
														<div class="form-group col mb-0">
															<button type="submit" class="btn btn-primary font-weight-bold positive-ls-3 btn-px-5 btn-py-3" data-loading-text="Loading..." data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light">
			...
			<div class="container py-5 mt-5">
				<div class="row">
					<div class="col-lg-3 mb-4 mb-lg-0">
						<a href="index.html" title="Porto Finance">
					...
					<div class="col-lg-3 mb-4 mb-lg-0">
						...
						<ul class="list list-unstyled columns-lg-2 text-3-5">
							...
							<li><a href="demo-finance-company.html">Company</a></li>
							<li><a href="demo-finance-strategies.html">Strategies</a></li>
							<li><a href="demo-finance-team.html">Team</a></li>
							<li><a href="demo-finance-blog.html">News</a></li>
							<li><a href="demo-finance-contact.html">Contact</a></li>
						</ul>
					</div>
					...
					<div class="col-lg-4">
						...
						<form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="mw-100">
							<div class="input-group">
								<input class="form-control bg-color-light-scale-1 border-0 px-4 text-3" placeholder="Email Adress..." name="newsletterEmail" id="newsletterEmail" type="email">
